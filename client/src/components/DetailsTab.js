    ...
    if (!state.author || !state.title) {
      ...
      const book = await axios
        .post("/api/books", {
          ...state,
          author:
            state.id || !global.capturedBook ? state.author : state.authors[0],
          ...
          <div className="md:grid md:grid-cols-2">
            <div>
              <img
                ...
                src={global.capturedBook.image || global.capturedBook.cover}
              ></img>
            </div>
            <div>
                  ...
                  <div>
                    ...
                    object.key === "isbn" ? (
                      ...
                      <InlineEdit
                        ...
                        readView={() => <div>{state[object.key] || ""}</div>}
                        onConfirm={(value) =>
                  ...
                  <InlineEdit
                    ...
                    readView={() => {
                      if (!state[object.key]) {
                        ...
                        return <div>{state[object.key] || object.key}</div>;
                      }
                    }}
                    onConfirm={(value) =>
                      handleDetailsChange(value, object.key)
