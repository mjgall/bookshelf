...
export default class Profile extends React.Component {
  ...
  calcMemberRole = (member) => {
    if (Number(member.user_id) === this.props.user.id && member.is_owner) {
      return (
        <div>
          You <span className="font-thin text-sm">(Owner)</span>
        </div>
      );
      ...
      return (
        <div>
          ...
          <span className="font-thin text-sm">(Owner)</span>
        </div>
      );
    } else {
  ...
  render = () => {
    return (
      <div className="max-w-screen-xl container my-4 ">
        <div
            ...
            <div className="w-5/6 md:w-full container">
              <div className="flex items-center w-full justify-between">
                <div className="flex items-center justify-center">
                  <span className="text-3xl font-bold">Households</span>
                  <span className="ml-2">
                    <Tip
                      content="Households allow you to share books in your home and notes on them."
                      placement="right"
                      size="1rem"
                    ></Tip>
                  </span>
              ...
              {this.state.households.length < 1 ? (
                <div className="my-1 text-gray-500 italic font-weight-light">
                  You don't have any households. Add one to the right. Once
                  you've added a household, you can invite members of your home.
                </div>
              ) : null}
              {this.state.addHousehold ? (
                  ...
                  return (
                    ...
                    >
                      <div className="text-2xl font-bold mb-3 flex justify-between items-center">
                        ...
                        this.state.editingHouseholdIndex === index ? (
                          // "hello"
                          // <Textfield
                          // 	value={
