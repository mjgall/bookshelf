...
module.exports = (userId) => {
    return new Promise((resolve, reject) => {
        const query = `SELECT activities.*, global_books.title, users.id AS friend_id, users.email AS friend_email, users.full AS friend_full, users.picture AS friend_picture FROM friendships 
        JOIN users 
